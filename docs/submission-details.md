...
- **Link to Demo Video:** https://youtu.be/LSkvvrFh4n4
- **Submission File:** `docs/OneLink-Pay-UXmaxx-Judge-Deck.pdf`
...
- **Technical quality / polish (10%):** SpendPolicy source-verified on-chain; 22 contract + 297 unit tests; typed end to end; claim-discipline `/trust`.

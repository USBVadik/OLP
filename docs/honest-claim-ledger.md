...
- ❌ "OneLink Pay supports cross-chain value movement via the Universal Account."
  Reason: Particle V2 settlement currently fails (`REFUND_FAILED` / `-32613`). Add row only
  after a successful cross-chain settlement is observed end-to-end on mainnet.
...
(see `docs/risk-register.md` — R2, R3, R7, R8, R15, R17 closed 2026-06-21; R16, R18 in_progress)
